...
public class LimesMainTest {
  ...
  private String endpointImport = "http://192.168.2.29:8890/sparql";
  private String acceptGraph = "http://generator.geoknow.eu/resource/test_accepted";
  private String reviewGraph = "http://generator.geoknow.eu/resource/test_review";
  private String uriBase = "http://ontos.com/resource/";
  private String configurationFileTest = "dbpedia-actors.xml";

  /**
   * Test limes. If endpoint for testing are not responding you can change the configurationFileTest
   * configuration file available in the resources if the one set by default is not working
   * 
   * @throws Exception
   */
  @Test
