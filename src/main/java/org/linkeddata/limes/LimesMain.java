...
public class LimesMain {
    ...
    // private static HttpURLConnection executeSpqrql(String endpoint, String
    // sparqlQuery)
    // throws Exception {
    ...
    // }
    //
    // private static HttpURLConnection httpPost(String url, String
    // urlParameters) throws IOException {
    //
